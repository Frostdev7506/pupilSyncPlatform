            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              >
                ...
                <h1 className="text-5xl md:text-6xl font-bold leading-tight bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600 2xl:h-[126px]">
                  Empower Your <br className="hidden lg:block" />Teaching Practice
                </h1>
                <motion.p 
                  variants={fadeIn}
                  className="mt-6 text-xl text-muted-foreground max-w-2xl mx-auto lg:mx-0"
                >
                  The next-generation platform designed to help educators create engaging lessons, track student progress, and save time.
                </motion.p>
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <CheckCircle className="h-5 w-5 text-emerald-500" />
                    <span className="text-sm">Trusted by 50K+ educators</span>
                  </div>
                </motion.div>
              </motion.div>
            </div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-10">
              Join thousands of educators already experiencing the future of teaching.
            </p>
